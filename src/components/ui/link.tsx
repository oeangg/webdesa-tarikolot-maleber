    ...
    <NavLink
      ...
      className={cn(
        ...
        theme === "bg"
          ...
          : "border-2 border-primaryColor/80 text-primaryColor/80 hover:border-primaryColor/70 hover:bg-hoverColor hover:text-primaryColor hover:shadow-xl hover:shadow-hoverColor/40",
        size === "md"
