...
export const HamburgerMenu = ({ onClick, isMobile }: PropsType) => {
  return (
    <button
      onClick={onClick}
      className="flex flex-col items-center justify-center gap-[6px] rounded-sm border border-primaryColor/80 p-[6px] font-semibold text-backgroundColor md:hidden"
    >
      <span
